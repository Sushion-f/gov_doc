<template>
  <div class="task-progress-card">
    <div class="task-progress-header" @click="toggleCollapse">
      ...
      <div class="header-right">
        <el-icon v-if="allCompleted" class="check-icon"><Check /></el-icon>
...
import { ArrowDown, Check, CircleCheckFilled, CircleClose, Loading } from '@element-plus/icons-vue';
...
const props = withDefaults(defineProps<Props>(), {
  tasks: () => [
    ...
    { id: '4', title: '输出完整分析报告到 docs 目录', status: 'completed' },
